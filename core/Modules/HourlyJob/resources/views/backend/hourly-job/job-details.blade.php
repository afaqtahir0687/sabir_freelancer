                                        ...
                                        <div class="tab-content-item dashboard-tab-content-item active" id="basic">
                                            <div class="project-preview-tab-header">
                                                ...
                                                <div class="project-preview-tab-header-item">
                                                    @if($job->type == 'hourly')
                                                        <span class="left">
                                                        <i class="fa-regular fa-clock"></i> {{ __('Hourly Rate') }}
                                                    </span>
                                                        <strong class="right">{{ amount_with_currency_symbol($job->hourly_rate ?? '') }}</strong>
                                                        @else
                                                        <span class="left">
                                                        <i class="fa-regular fa-clock"></i> {{ __('Budget') }}
                                                        </span>
                                                        <strong class="right">{{ amount_with_currency_symbol($job->budget ?? '') }}</strong>
                                                        @endif
                                                </div>
                                            </div>
