...
@section('site_title',__('Packages'))
@section('style')
    <style>
...
@section('content')
    <main>
        <x-breadcrumb.user-profile-breadcrumb :title="__('Packages')" :innerTitle="__('Packages')"/>
                                    ...
                                    <div class="single-profile-settings-contents">
                                        <div class="single-profile-settings-contents-upload">
                                            <div class="single-profile-settings-contents-upload-btn">
                                                <a href="{{ route('subscriptions.all') }}" class="btn-profile btn-bg-1">{{ __('Buy Packages') }}</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="single-profile-settings" id="display_client_profile_info">
                                <div class="single-profile-settings-header">
                                    ...
                                    <div class="single-profile-settings-header-flex">
                                        <x-form.form-title :title="__('Packages History')" :class="'single-profile-settings-header-title'" />
