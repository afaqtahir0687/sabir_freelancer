<table class="DataTable_activation">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                @can('email-template-update')
                <a href="{{ route('admin.password.reset.email') }}" class="btn-profile btn-bg-1"> {{ __('Edit Template') }}</a>
                @endcan
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                {{ __('Package Purchase Email to User') }}
                <p><small class="text-info">{{__('This email will send to user when the user buy a package.')}}</small></p>
            </td>
            <td>
                @can('email-template-update')
        ...
        <tr>
            ...
            <td>
                {{ __('Package Purchase Email to Admin') }}
                <p><small class="text-info">{{__('This email will send to admin when the user buy a package.')}}</small></p>
            </td>
            <td>
                @can('email-template-update')
        ...
        <tr>
            ...
            <td>
                {{ __('Manual Package Payment Complete Email To User') }}
        ...
        <tr>
            ...
            <td>
                {{ __('Manual Package Payment Complete Email To Admin') }}
        ...
        <tr>
            ...
            <td>
                {{ __('Package Active Email To User') }}
                <p><small class="text-info">{{__('This email will send to user when the admin change the package status inactive to active.')}}</small></p>
            </td>
            <td>
                @can('email-template-update')
        ...
        <tr>
            ...
            <td>
                {{ __('Package Inactive Email To User') }}
                <p><small class="text-info">{{__('This email will send to user when the admin change the package status active to inactive.')}}</small></p>
            </td>
            <td>
                @can('email-template-update')
