                ...
                <div class="customMarkup__single">
                    <div class="customMarkup__single__item">
                        <div class="customMarkup__single__item__flex">
                            <h4 class="customMarkup__single__title">{{ __('User Package Purchase Email') }}</h4>
                        </div>
                        ...
                        <div class="customMarkup__single__inner mt-4">
                            ...
                            <form action="{{route('admin.user.subscription.buy')}}" method="POST" enctype="multipart/form-data">
                                ...
                                <x-form.text
                                    ...
                                    :value="get_static_option('user_subscription_purchase_subject') ?? __('User Package Purchase Email')"
                                />
                                <x-form.summernote
