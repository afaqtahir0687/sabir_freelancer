...
class ClientController extends Controller
{
    ...
    public function profile()
    {
        ...
        $step2Complete = $identity_verification && $identity_verification->status === 1;

        return view('frontend.user.client.profile.profile-settings', compact('countries', 'states', 'cities', 'user',  'step1Complete', 'step2Complete'));
    }
   ...
   public function edit_profile(Request $request)
    ...
    public function identity_verification(Request $request)
    {
        ...
        return view('frontend.user.client.identity.verification',compact('user_identity', 'countries', 'states', 'cities', 'step1Complete', 'step2Complete'));
    }
