...
-- Dumping database structure for freelancer
CREATE DATABASE IF NOT EXISTS `freelancer` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `freelancer`;

-- Dumping structure for table freelancer.admins
...
-- Dumping data for table freelancer.admins: ~1 rows (approximately)
DELETE FROM `admins`;
INSERT INTO `admins` (`id`, `name`, `username`, `email`, `is_email_verified`, `email_verify_token`, `phone`, `role`, `image`, `password`, `status`, `designation`, `about`, `remember_token`, `created_at`, `updated_at`) VALUES
	(1, 'Fazal', 'super_admin', 'miranweb@gmail.com', 0, NULL, NULL, 'editor', NULL, '$2y$10$KEDWTXj/q5NXPSSXgKZE8eMkKKuvK5mYXYlDvsmgVso1Ixc0mW37G', 1, NULL, NULL, 'B5lV44aMQ17spuRMj9lKvm83LenSBHx98UbbbEVUntDjiFS5y8KuIi7B3yAL', NULL, NULL);

-- Dumping structure for table freelancer.admin_notifications
...
-- Dumping data for table freelancer.admin_notifications: ~0 rows (approximately)
DELETE FROM `admin_notifications`;
INSERT INTO `admin_notifications` (`id`, `identity`, `user_id`, `type`, `message`, `is_read`, `created_at`, `updated_at`) VALUES
	(1, 149, 8, 'Create Project', 'A new project has been created', 'read', '2024-09-07 02:41:20', '2024-09-07 02:58:35');

-- Dumping structure for table freelancer.blog_posts
...
-- Dumping data for table freelancer.blog_posts: ~4 rows (approximately)
...
-- Dumping structure for table freelancer.bookmarks
...
-- Dumping data for table freelancer.bookmarks: ~0 rows (approximately)
DELETE FROM `bookmarks`;

-- Dumping structure for table freelancer.categories
...
-- Dumping data for table freelancer.categories: ~9 rows (approximately)
...
-- Dumping structure for table freelancer.chat_messages
...
-- Dumping data for table freelancer.chat_messages: ~0 rows (approximately)
DELETE FROM `chat_messages`;

-- Dumping structure for table freelancer.cities
...
-- Dumping data for table freelancer.cities: ~9 rows (approximately)
DELETE FROM `cities`;
...
-- Dumping structure for table freelancer.client_notifications
...
-- Dumping data for table freelancer.client_notifications: ~0 rows (approximately)
DELETE FROM `client_notifications`;

-- Dumping structure for table freelancer.countries
...
-- Dumping data for table freelancer.countries: ~11 rows (approximately)
...
-- Dumping structure for table freelancer.departments
...
-- Dumping data for table freelancer.departments: ~4 rows (approximately)
...
-- Dumping structure for table freelancer.failed_jobs
...
-- Dumping data for table freelancer.failed_jobs: ~0 rows (approximately)
DELETE FROM `failed_jobs`;

-- Dumping structure for table freelancer.feedback
...
-- Dumping data for table freelancer.feedback: ~7 rows (approximately)
...
-- Dumping structure for table freelancer.form_builders
...
-- Dumping data for table freelancer.form_builders: ~2 rows (approximately)
...
-- Dumping structure for table freelancer.freelancer_levels
...
-- Dumping data for table freelancer.freelancer_levels: ~3 rows (approximately)
DELETE FROM `freelancer_levels`;
...
-- Dumping structure for table freelancer.freelancer_level_rules
CREATE TABLE IF NOT EXISTS `freelancer_level_rules` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
...
-- Dumping data for table freelancer.freelancer_level_rules: ~3 rows (approximately)
DELETE FROM `freelancer_level_rules`;
...
-- Dumping structure for table freelancer.freelancer_notifications
...
-- Dumping data for table freelancer.freelancer_notifications: ~0 rows (approximately)
DELETE FROM `freelancer_notifications`;

-- Dumping structure for table freelancer.identity_verifications
...
-- Dumping data for table freelancer.identity_verifications: ~4 rows (approximately)
...
-- Dumping structure for table freelancer.individual_commission_settings
CREATE TABLE IF NOT EXISTS `individual_commission_settings` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `user_id` bigint NOT NULL,
...
-- Dumping data for table freelancer.individual_commission_settings: ~0 rows (approximately)
DELETE FROM `individual_commission_settings`;
...
-- Dumping structure for table freelancer.jobs
...
-- Dumping data for table freelancer.jobs: ~0 rows (approximately)
DELETE FROM `jobs`;

-- Dumping structure for table freelancer.job_histories
...
-- Dumping data for table freelancer.job_histories: ~16 rows (approximately)
...
-- Dumping structure for table freelancer.job_posts
...
-- Dumping data for table freelancer.job_posts: ~36 rows (approximately)
...
-- Dumping structure for table freelancer.job_post_skills
...
-- Dumping data for table freelancer.job_post_skills: ~103 rows (approximately)
...
-- Dumping structure for table freelancer.job_post_sub_categories
CREATE TABLE IF NOT EXISTS `job_post_sub_categories` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `job_post_id` bigint NOT NULL,
...
-- Dumping data for table freelancer.job_post_sub_categories: ~58 rows (approximately)
DELETE FROM `job_post_sub_categories`;
...
-- Dumping structure for table freelancer.job_proposals
...
-- Dumping data for table freelancer.job_proposals: ~25 rows (approximately)
...
-- Dumping structure for table freelancer.languages
...
-- Dumping data for table freelancer.languages: ~0 rows (approximately)
...
-- Dumping structure for table freelancer.live_chats
...
-- Dumping data for table freelancer.live_chats: ~0 rows (approximately)
DELETE FROM `live_chats`;

-- Dumping structure for table freelancer.live_chat_messages
...
-- Dumping data for table freelancer.live_chat_messages: ~0 rows (approximately)
DELETE FROM `live_chat_messages`;

-- Dumping structure for table freelancer.log_activities
...
-- Dumping data for table freelancer.log_activities: ~0 rows (approximately)
DELETE FROM `log_activities`;

-- Dumping structure for table freelancer.media_uploads
...
-- Dumping data for table freelancer.media_uploads: ~145 rows (approximately)
...
-- Dumping structure for table freelancer.menus
...
-- Dumping data for table freelancer.menus: ~4 rows (approximately)
DELETE FROM `menus`;
...
-- Dumping structure for table freelancer.meta_data
...
-- Dumping data for table freelancer.meta_data: ~9 rows (approximately)
...
-- Dumping structure for table freelancer.migrations
...
-- Dumping data for table freelancer.migrations: ~142 rows (approximately)
...
-- Dumping structure for table freelancer.model_has_permissions
...
-- Dumping data for table freelancer.model_has_permissions: ~0 rows (approximately)
DELETE FROM `model_has_permissions`;

-- Dumping structure for table freelancer.model_has_roles
...
-- Dumping data for table freelancer.model_has_roles: ~1 rows (approximately)
DELETE FROM `model_has_roles`;
INSERT INTO `model_has_roles` (`role_id`, `model_type`, `model_id`) VALUES
	(1, 'App\\Models\\Admin', 1);

-- Dumping structure for table freelancer.newsletters
...
-- Dumping data for table freelancer.newsletters: ~10 rows (approximately)
...
-- Dumping structure for table freelancer.news_letter_for_emails
CREATE TABLE IF NOT EXISTS `news_letter_for_emails` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `email` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `token` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `verified` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
-- Dumping data for table freelancer.news_letter_for_emails: ~0 rows (approximately)
DELETE FROM `news_letter_for_emails`;

-- Dumping structure for table freelancer.offers
...
-- Dumping data for table freelancer.offers: ~109 rows (approximately)
DELETE FROM `offers`;
...
-- Dumping structure for table freelancer.offer_milestones
...
-- Dumping data for table freelancer.offer_milestones: ~19 rows (approximately)
DELETE FROM `offer_milestones`;
...
-- Dumping structure for table freelancer.orders
...
-- Dumping data for table freelancer.orders: ~553 rows (approximately)
DELETE FROM `orders`;
...
-- Dumping structure for table freelancer.order_decline_histories
CREATE TABLE IF NOT EXISTS `order_decline_histories` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
...
-- Dumping data for table freelancer.order_decline_histories: ~20 rows (approximately)
DELETE FROM `order_decline_histories`;
...
-- Dumping structure for table freelancer.order_decline_wallet_histories
CREATE TABLE IF NOT EXISTS `order_decline_wallet_histories` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `order_id` bigint NOT NULL,
  `freelancer_id` bigint NOT NULL,
  `client_id` bigint NOT NULL,
...
-- Dumping data for table freelancer.order_decline_wallet_histories: ~20 rows (approximately)
DELETE FROM `order_decline_wallet_histories`;
...
-- Dumping structure for table freelancer.order_milestones
...
-- Dumping data for table freelancer.order_milestones: ~47 rows (approximately)
...
-- Dumping structure for table freelancer.order_request_revisions
CREATE TABLE IF NOT EXISTS `order_request_revisions` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `order_id` bigint NOT NULL,
...
-- Dumping data for table freelancer.order_request_revisions: ~4 rows (approximately)
DELETE FROM `order_request_revisions`;
INSERT INTO `order_request_revisions` (`id`, `order_id`, `order_submit_history_id`, `milestone_id`, `description`, `created_at`, `updated_at`) VALUES
	(1, 2, 1, NULL, _binary , '2023-11-07 00:42:48', '2023-11-07 00:42:48'),
	(2, 11, 12, 8, _binary , '2023-11-14 23:58:27', '2023-11-14 23:58:27'),
	(3, 456, 17, 35, _binary , '2024-06-04 11:43:35', '2024-06-04 11:43:35'),
	(4, 546, 23, NULL, _binary 0x4b7a6b7a, '2024-08-17 19:58:23', '2024-08-17 19:58:23');

-- Dumping structure for table freelancer.order_screenshots
...
-- Dumping data for table freelancer.order_screenshots: ~0 rows (approximately)
DELETE FROM `order_screenshots`;

-- Dumping structure for table freelancer.order_submit_histories
CREATE TABLE IF NOT EXISTS `order_submit_histories` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `order_id` bigint NOT NULL,
...
-- Dumping data for table freelancer.order_submit_histories: ~26 rows (approximately)
DELETE FROM `order_submit_histories`;
...
-- Dumping structure for table freelancer.order_work_histories
CREATE TABLE IF NOT EXISTS `order_work_histories` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `order_id` int NOT NULL,
...
-- Dumping data for table freelancer.order_work_histories: ~0 rows (approximately)
DELETE FROM `order_work_histories`;
...
-- Dumping structure for table freelancer.pages
...
-- Dumping data for table freelancer.pages: ~6 rows (approximately)
DELETE FROM `pages`;
...
-- Dumping structure for table freelancer.page_builders
...
-- Dumping data for table freelancer.page_builders: ~29 rows (approximately)
DELETE FROM `page_builders`;
...
-- Dumping structure for table freelancer.password_resets
...
-- Dumping data for table freelancer.password_resets: ~0 rows (approximately)
DELETE FROM `password_resets`;

-- Dumping structure for table freelancer.permissions
...
-- Dumping data for table freelancer.permissions: ~208 rows (approximately)
...
-- Dumping structure for table freelancer.personal_access_tokens
...
-- Dumping data for table freelancer.personal_access_tokens: ~0 rows (approximately)
DELETE FROM `personal_access_tokens`;

-- Dumping structure for table freelancer.portfolios
...
-- Dumping data for table freelancer.portfolios: ~7 rows (approximately)
...
-- Dumping structure for table freelancer.projects
...
-- Dumping data for table freelancer.projects: ~29 rows (approximately)
...
INSERT INTO `projects` (`id`, `user_id`, `category_id`, `title`, `slug`, `description`, `image`, `basic_title`, `standard_title`, `premium_title`, `basic_revision`, `standard_revision`, `premium_revision`, `basic_delivery`, `standard_delivery`, `premium_delivery`, `basic_regular_charge`, `basic_discount_charge`, `standard_regular_charge`, `standard_discount_charge`, `premium_regular_charge`, `premium_discount_charge`, `project_on_off`, `project_approve_request`, `status`, `is_pro`, `pro_expire_date`, `offer_packages_available_or_not`, `meta_title`, `meta_description`, `meta_tags`, `load_from`, `is_synced`, `created_at`, `updated_at`) VALUES
	...
	(149, 8, 1, 'UI UX TItle 1 UI UX TItle 1', 'ui-ux-title-1-ui-ux-title-1', '<p>some description some description some description some description some description some description some description some description some description some description some description some description some description some description some description some description some description some description some description some description some description some description some description some description some description some description some description some description some description some description some description some description&nbsp;</p>', '1725698479-66dc11af45a02.jpg', 'Basic', 'Standard', 'Premium', '1', '1', '1', '1 Days', '1 Days', '1 Days', 50, 40, 60, 50, 70, 60, 1, 0, 0, NULL, NULL, 1, NULL, NULL, NULL, 0, 0, '2024-09-07 02:41:19', '2024-09-07 02:41:19');

-- Dumping structure for table freelancer.project_attributes
...
-- Dumping data for table freelancer.project_attributes: ~124 rows (approximately)
...
INSERT INTO `project_attributes` (`id`, `user_id`, `create_project_id`, `type`, `check_numeric_title`, `basic_check_numeric`, `standard_check_numeric`, `premium_check_numeric`, `created_at`, `updated_at`) VALUES
	...
	(1835, 8, 149, 'checkbox', 'Test 1', 'on', 'on', 'on', '2024-09-07 02:41:19', '2024-09-07 02:41:19');

-- Dumping structure for table freelancer.project_histories
...
-- Dumping data for table freelancer.project_histories: ~21 rows (approximately)
DELETE FROM `project_histories`;
...
-- Dumping structure for table freelancer.project_promote_settings
CREATE TABLE IF NOT EXISTS `project_promote_settings` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `title` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `image` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `budget` double NOT NULL,
...
-- Dumping data for table freelancer.project_promote_settings: ~3 rows (approximately)
DELETE FROM `project_promote_settings`;
...
-- Dumping structure for table freelancer.project_sub_categories
...
-- Dumping data for table freelancer.project_sub_categories: ~95 rows (approximately)
DELETE FROM `project_sub_categories`;
INSERT INTO `project_sub_categories` (`id`, `project_id`, `sub_category_id`, `created_at`, `updated_at`) VALUES
	...
	(183, 149, 1, '2024-09-07 02:41:19', '2024-09-07 02:41:19');

-- Dumping structure for table freelancer.promotion_project_lists
CREATE TABLE IF NOT EXISTS `promotion_project_lists` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `user_id` bigint NOT NULL,
...
-- Dumping data for table freelancer.promotion_project_lists: ~13 rows (approximately)
DELETE FROM `promotion_project_lists`;
...
-- Dumping structure for table freelancer.question_answers
...
-- Dumping data for table freelancer.question_answers: ~26 rows (approximately)
...
-- Dumping structure for table freelancer.ratings
...
-- Dumping data for table freelancer.ratings: ~10 rows (approximately)
DELETE FROM `ratings`;
...
-- Dumping structure for table freelancer.rating_details
...
-- Dumping data for table freelancer.rating_details: ~56 rows (approximately)
DELETE FROM `rating_details`;
...
-- Dumping structure for table freelancer.reports
...
-- Dumping data for table freelancer.reports: ~0 rows (approximately)
DELETE FROM `reports`;

-- Dumping structure for table freelancer.roles
...
-- Dumping data for table freelancer.roles: ~3 rows (approximately)
DELETE FROM `roles`;
...
-- Dumping structure for table freelancer.role_has_permissions
...
-- Dumping data for table freelancer.role_has_permissions: ~0 rows (approximately)
...
-- Dumping structure for table freelancer.skills
...
-- Dumping data for table freelancer.skills: ~45 rows (approximately)
DELETE FROM `skills`;
...
-- Dumping structure for table freelancer.states
...
-- Dumping data for table freelancer.states: ~11 rows (approximately)
DELETE FROM `states`;
...
-- Dumping structure for table freelancer.static_options
...
-- Dumping data for table freelancer.static_options: ~399 rows (approximately)
DELETE FROM `static_options`;
...
-- Dumping structure for table freelancer.subscriptions
...
-- Dumping data for table freelancer.subscriptions: ~10 rows (approximately)
...
-- Dumping structure for table freelancer.subscription_features
...
-- Dumping data for table freelancer.subscription_features: ~70 rows (approximately)
...
-- Dumping structure for table freelancer.subscription_types
...
-- Dumping data for table freelancer.subscription_types: ~4 rows (approximately)
...
-- Dumping structure for table freelancer.sub_categories
...
-- Dumping data for table freelancer.sub_categories: ~21 rows (approximately)
...
-- Dumping structure for table freelancer.tickets
...
-- Dumping data for table freelancer.tickets: ~0 rows (approximately)
DELETE FROM `tickets`;

-- Dumping structure for table freelancer.users
...
-- Dumping data for table freelancer.users: ~13 rows (approximately)
DELETE FROM `users`;
INSERT INTO `users` (`id`, `first_name`, `last_name`, `hourly_rate`, `experience_level`, `email`, `phone`, `username`, `password`, `image`, `country_id`, `state_id`, `city_id`, `user_type`, `check_online_status`, `check_work_availability`, `user_active_inactive_status`, `user_verified_status`, `is_suspend`, `terms_condition`, `about`, `is_email_verified`, `google_2fa_secret`, `google_2fa_enable_disable_disable`, `google_id`, `facebook_id`, `github_id`, `apple_id`, `is_pro`, `pro_expire_date`, `email_verify_token`, `firebase_device_token`, `freeze_withdraw`, `freeze_project`, `freeze_job`, `freeze_chat`, `freeze_order_create`, `email_verified_at`, `remember_token`, `load_from`, `is_synced`, `created_at`, `updated_at`, `deleted_at`) VALUES
	...
	(8, 'Ryan', 'Wayne', 20, 'junior', 'riad@gmail.com', '01711111111', 'riad', '$2y$10$sXCk0xU6shlnk8QuJWvmSeca/vDULwFCOgKQP68TyPIbObo7cIFWa', '1725699039-66dc13df00b89.jpg', 2, 16, 2, 2, '2024-09-07 02:58:09', 1, 1, 1, 0, 1, NULL, '1', NULL, 0, NULL, NULL, NULL, NULL, 'yes', '2024-10-06 15:44:08', '525550', 'fJF8CvUVTIG5RNHgomtaOz:APA91bEHpv7jMahHx0vzMs7eZXC1Fje-1THGpgeGi57SJdQqeyEH0WXcVR1-8avx7E84GehadnH54HvqOKTJTgtOEkNPaqmyOGHl3hdWJjSikW7o0Q5v5yjG-_RdE-LM4wpOT51H3VUI', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, '2023-09-29 22:40:49', '2024-09-07 02:58:09', NULL),
...
-- Dumping structure for table freelancer.user_earnings
...
-- Dumping data for table freelancer.user_earnings: ~2 rows (approximately)
...
-- Dumping structure for table freelancer.user_education
...
-- Dumping data for table freelancer.user_education: ~2 rows (approximately)
...
-- Dumping structure for table freelancer.user_experiences
...
-- Dumping data for table freelancer.user_experiences: ~3 rows (approximately)
...
-- Dumping structure for table freelancer.user_introductions
...
-- Dumping data for table freelancer.user_introductions: ~4 rows (approximately)
DELETE FROM `user_introductions`;
...
-- Dumping structure for table freelancer.user_notifications
...
-- Dumping data for table freelancer.user_notifications: ~0 rows (approximately)
DELETE FROM `user_notifications`;

-- Dumping structure for table freelancer.user_skills
...
-- Dumping data for table freelancer.user_skills: ~2 rows (approximately)
...
-- Dumping structure for table freelancer.user_subscriptions
...
-- Dumping data for table freelancer.user_subscriptions: ~9 rows (approximately)
...
-- Dumping structure for table freelancer.user_works
...
-- Dumping data for table freelancer.user_works: ~0 rows (approximately)
...
-- Dumping structure for table freelancer.wallets
...
-- Dumping data for table freelancer.wallets: ~0 rows (approximately)
DELETE FROM `wallets`;
...
-- Dumping structure for table freelancer.wallet_histories
...
-- Dumping data for table freelancer.wallet_histories: ~0 rows (approximately)
DELETE FROM `wallet_histories`;

-- Dumping structure for table freelancer.widgets
...
-- Dumping data for table freelancer.widgets: ~0 rows (approximately)
DELETE FROM `widgets`;
...
-- Dumping structure for table freelancer.withdraw_gateways
CREATE TABLE IF NOT EXISTS `withdraw_gateways` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
-- Dumping data for table freelancer.withdraw_gateways: ~0 rows (approximately)
DELETE FROM `withdraw_gateways`;
...
-- Dumping structure for table freelancer.withdraw_requests
...
-- Dumping data for table freelancer.withdraw_requests: ~0 rows (approximately)
DELETE FROM `withdraw_requests`;

-- Dumping structure for table freelancer.words
...
-- Dumping data for table freelancer.words: ~0 rows (approximately)
DELETE FROM `words`;
...
-- Dumping structure for table freelancer.xg_ftp_infos
...
-- Dumping data for table freelancer.xg_ftp_infos: ~0 rows (approximately)
DELETE FROM `xg_ftp_infos`;

-- Dumping structure for table freelancer.xg_payment_meta
...
-- Dumping data for table freelancer.xg_payment_meta: ~0 rows (approximately)
DELETE FROM `xg_payment_meta`;
