...
@section('style')
{{--    <link rel="stylesheet" href="{{asset('assets/backend/css/cropimage.min.css')}}">--}}
...
@section('script')
{{--    <script src="{{asset('assets/backend/js/cropimage.min.js')}}" type="application/javascript"></script>--}}
