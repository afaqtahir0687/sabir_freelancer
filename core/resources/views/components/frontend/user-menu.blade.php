                            ...
                            <div class="navbar-author-wrapper-list">
                                @if (Auth::guard('web')->user()->user_type == 1)
                                    ...
                                    <a href="{{ route('client.ad.manage') }}"
                                       class="navbar-author-wrapper-list-item">
                                        ...
                                        <form action="{{ route('client.switch.account') }}" method="POST">
                                            @csrf
                                            @if(Auth::user()->user_type == 1)
                                                <button type="submit" class="dropdown-item navbar-author-wrapper-list-item">🔁 Switch to Freelancer</button>
                                            @else
                                                <button type="submit" class="dropdown-item navbar-author-wrapper-list-item"> Switch to Client</button>
                                            @endif
                                        </form>
                                ...
                                @else
                                    ...
                                    @if(get_static_option('project_enable_disable') != 'disable')
                                        ...
                                        @endif
                                    @endif
                                    <a href="{{ route('freelancer.ad.manage') }}"
                                       class="navbar-author-wrapper-list-item">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                             xmlns="http://www.w3.org/2000/svg">
                                            <path
                                    ...
                                    <form action="{{ route('freelancer.switch.account') }}" method="POST">
                                        @csrf
