...
@if(get_static_option('project_enable_disable') != 'disable')
    ...
    <!-- Project area starts -->
    <section class="project-area pat-50 pab-50 section-bg-1" data-padding-top="{{$padding_top ?? ''}}" data-padding-bottom="{{$padding_bottom ?? ''}}" style="background-color:{{$section_bg ?? ''}}">
        <div class="container">
                                            ...
                                            <div class="project-item wow fadeInUp" data-wow-delay=".1s">
                                                <div class="single-project radius-10">
                                                    ...
                                                    <div class="single-project-content">
                                                        ...
                                                        <h4 class="single-project-content-title"> <a href="{{ route('project.details', ['username' => $project->project_creator?->username, 'slug' => $project->slug]) }}">{{ \Illuminate\Support\Str::limit($project->title, 50) }} </a> </h4>
                                                    </div>
